...
set JAVA_VERSION=17
set MAIN_JAR=FlamingArrowsGameMainUI-%PROJECT_VERSION%.jar
...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\org\amazons\mainui\App.class > temp.txt
...
call "%JAVA_HOME%\bin\jpackage" ^
  ...
  --icon src/main/logo/windows/icon.ico ^
  --app-version %APP_VERSION% ^
  --vendor "Paperweights UMSL CS 4500." ^
  --copyright "Copyright © 2021 Paperweights" ^
  --win-dir-chooser ^
  --win-shortcut ^
